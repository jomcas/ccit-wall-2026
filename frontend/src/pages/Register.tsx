...
import { FiUserPlus, FiUser, FiMail, FiLock, FiEye, FiEyeOff, FiCheck, FiX, FiBookOpen, FiUsers } from 'react-icons/fi';
...
const Register: React.FC = () => {
  ...
  return (
    <AuthLayout title="Join CCIT Wall" subtitle="Create your account to get started">
      ...
      <div className="auth-form__role-selector">
        <button
          type="button"
          className={`auth-form__role-option ${role === 'student' ? 'auth-form__role-option--active' : ''}`}
          onClick={() => setRole('student')}
        >
          <FiBookOpen size={16} /> Student
        </button>
        <button
          type="button"
          className={`auth-form__role-option ${role === 'teacher' ? 'auth-form__role-option--active' : ''}`}
          onClick={() => setRole('teacher')}
        >
          <FiUsers size={16} /> Teacher
        </button>
      </div>
      ...
      <p className="auth-form__footer" style={{ marginTop: 'var(--space-4)' }}>
